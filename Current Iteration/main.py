...
from save         import (
    ...
    list_fight_logs, load_fight_log, print_save_status, generate_static_dashboard,
...
def main_menu(gs: GameState):
    while True:
        ...
        elif MAIN_MENU_OPTIONS[idx] == "Update & Open HTML Records":
            path = generate_static_dashboard()
            import webbrowser
