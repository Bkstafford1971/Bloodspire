...
STYLE_PROPERTIES: dict[str, StyleProperties] = {
    # Endurance burn tiers (base values; gear, activity, and mitigation add on top):
    #   AGGRESSIVE  (Total Kill/Bash/Martial Combat/Lunge/Strike/Slash): 1.8–2.5
    #   MID-TIER    (Wall of Steel/Decoy/Opp. Throw/Engage & Withdraw): 1.1–1.5
    #   COUNTERSTRIKE (between mid and passive):                         0.9
    #   PASSIVE     (Parry/Defend/Sure Strike/Calculated Attack):        0.8–0.9
    #
    # Exhaustion is a failsafe, not the primary fight-ender. Aggressive styles
    # should reach Phase II in 3+ minutes of sustained fighting; passive styles
    # should rarely exhaust in normal fight lengths.

    # ── AGGRESSIVE ─────────────────────────────────────────────────────────
    "Total Kill": StyleProperties(
        apm_modifier=1.5, damage_modifier=5.0,
        parry_bonus=-8, dodge_bonus=-8,
        endurance_burn=2.5, intimidate=True,
        anxiously_awaits=False, total_kill_mode=True,
        notes="Berserk. High damage, nearly no defense. Burns out fastest.",
    ),
    ...
    "Martial Combat": StyleProperties(
        ...
        parry_bonus=1, dodge_bonus=2,
        endurance_burn=2.2, intimidate=False,
        anxiously_awaits=False, total_kill_mode=False,
        notes="Special brawl attacks. Kick, punch, sweep. High endurance cost.",
    ),
    "Lunge": StyleProperties(
        apm_modifier=0.5, damage_modifier=-1.0,
        parry_bonus=0, dodge_bonus=4,
        endurance_burn=1.8, intimidate=False,
        anxiously_awaits=False, total_kill_mode=False,
        notes="Good dodge bonus. Rhythm bursts. High endurance cost.",
    ),
    "Strike": StyleProperties(
        ...
        notes="Average in all things. High endurance cost.",
    ),
    "Slash": StyleProperties(
        ...
        endurance_burn=1.8, intimidate=False,
        anxiously_awaits=False, total_kill_mode=False,
        notes="Special slash hits. Slow, poor defense. High endurance cost.",
    ),
    ...
    "Wall of Steel": StyleProperties(
        ...
        endurance_burn=1.5, intimidate=True,
        anxiously_awaits=False, total_kill_mode=False,
        notes="High attack rate, damage penalty. Moderate endurance cost.",
    ),
    "Engage & Withdraw": StyleProperties(
        apm_modifier=-0.3, damage_modifier=-1.0,
        parry_bonus=0, dodge_bonus=5,
        endurance_burn=1.1, intimidate=False,
        anxiously_awaits=True, total_kill_mode=False,
        notes="Very high dodge. Moderate endurance cost.",
    ),
    "Decoy": StyleProperties(
        apm_modifier=-0.5, damage_modifier=1.0,
        parry_bonus=3, dodge_bonus=-1,
        endurance_burn=1.3, intimidate=False,
        anxiously_awaits=False, total_kill_mode=False,
        notes="Negates defense point. Can block parry. Moderate endurance cost.",
    ),
    ...
    # ── COUNTERSTRIKE (between mid and passive) ────────────────────────────
    "Counterstrike": StyleProperties(
        apm_modifier=-1.5, damage_modifier=2.0,
        parry_bonus=2, dodge_bonus=0,
        endurance_burn=0.9, intimidate=False,
        anxiously_awaits=True, total_kill_mode=False,
        notes="Low native APM; counters provide extra attacks. Low-moderate endurance cost.",
    ),
    ...
    "Sure Strike": StyleProperties(
        ...
        endurance_burn=0.9, intimidate=False,
        anxiously_awaits=True, total_kill_mode=False,
        notes="Highest hit %. Slow. Very low endurance cost.",
    ),
    "Calculated Attack": StyleProperties(
        ...
        endurance_burn=0.9, intimidate=False,
        anxiously_awaits=True, total_kill_mode=False,
        notes="Hits critical locations. Slow. Very low endurance cost.",
    ),
    "Parry": StyleProperties(
        apm_modifier=-2.5, damage_modifier=-4.0,
        parry_bonus=6, dodge_bonus=2,
        endurance_burn=0.8, intimidate=False,
        anxiously_awaits=False, total_kill_mode=False,
        notes="Purely defensive. Lowest endurance cost.",
    ),
    "Defend": StyleProperties(
        ...
        endurance_burn=0.8, intimidate=False,
        anxiously_awaits=True, total_kill_mode=False,
        notes="Slightly more active than Parry. Still very defensive. Lowest endurance cost.",
    ),
}
