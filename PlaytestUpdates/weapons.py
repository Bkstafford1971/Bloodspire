...
class Weapon:
    ...
    display         : str
    weight          : float
    apm             : int           # Attacks per minute for this weapon (3-7)
    damage_base     : int           # Minimum damage per hit (before armor)
    damage_top      : int           # Maximum damage per hit (before armor)
    throwable       : bool
...
WEAPONS: dict[str, Weapon] = {
    ...
    "mace": Weapon(
        ...
        two_hand      = False,
        category      = HAMMER_MACE,
        notes="Solid blunt option. Reliable mid-range bludgeoning.",
