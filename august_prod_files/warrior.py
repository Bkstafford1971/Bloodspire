...
class Warrior:
    ...
    def __init__(
        ...
        # --- Arena Assignment ---
        # "normal" = The Agony Amphitheatre, "elite" = The Elite Spire, "veteran" = The Veteran's Keep
        self.current_arena: str = "normal"
        # Set to "elite" or "veteran" when promotion eligibility is met; cleared on promotion.
        self.pending_promotion: Optional[str] = None
    ...
    def _calc_max_endurance(self) -> int:
        """Max endurance pool: (CON × 5) + (STR × 2) + INT + (CON - 10) × 0.25 bonus"""
        con_bonus = int((self.constitution - 10) * 0.25)
        return (self.constitution * 5) + (self.strength * 2) + self.intelligence + con_bonus
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "current_arena":   self.current_arena,
    ...
    def from_dict(cls, data: dict) -> "Warrior":
        ...
        w.current_arena     = data.get("current_arena", "normal")
        w.pending_promotion = data.get("pending_promotion")
